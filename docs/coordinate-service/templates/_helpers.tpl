...
*/}}
{{- define "coordinate-service.chart" -}}
...
helm.sh/chart: {{ include "coordinate-service.chart" . }}
...
*/}}
{{- define "coordinate-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "coordinate-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
